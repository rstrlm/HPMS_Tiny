        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedByKeycloakId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_StaffProfiles_PerformedByStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomStateBlocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomStateBlocks_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomStateBlocks_StaffProfiles_CreatedByStaffId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomStateBlocks_CreatedByStaffId",
                table: "RoomStateBlocks",
                column: "CreatedByStaffId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomStateBlocks_RoomId_StartAtUtc_EndAtUtc_Type",
                table: "RoomStateBlocks",
                columns: new[] { "RoomId", "StartAtUtc", "EndAtUtc", "Type" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffProfiles_KeycloakUserId",
                table: "StaffProfiles",
